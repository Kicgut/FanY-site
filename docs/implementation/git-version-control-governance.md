...
是否涉及文件上传/删除
是否涉及 Hermes 或 AI 能力
是否需要更新 docs/project-management/tasks
验证方式
回滚方式
```
...
docs/project-management/tasks/04-photo-review-workflow.md
```
...
docs/architecture/content-pipeline.md
docs/project-management/tasks/08-content-pipeline.md
```
